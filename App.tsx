...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      <Routes>
        <Route path="/" element={<Dashboard audits={filteredAudits} obras={allObras} onNavigate={(p) => navigate(`/${p}`)} user={user} />} />
        <Route path="/dashboard" element={<Dashboard audits={filteredAudits} obras={allObras} onNavigate={(p) => navigate(`/${p}`)} user={user} />} />
        <Route path="/auditoria/nova" element={<AuditWizard obras={actionObras} currentUser={user} onAuditComplete={handleAuditComplete} onNavigate={(p) => navigate(`/${p}`)} />} />
        <Route path="/new-audit" element={<AuditWizard obras={actionObras} currentUser={user} onAuditComplete={handleAuditComplete} onNavigate={(p) => navigate(`/${p}`)} />} />
        <Route path="/obras" element={<ObrasManagement obras={allObras} audits={filteredAudits} onObraAdded={handleObraAdded} onSelectAudit={handleViewAudit} onNavigate={(p) => navigate(`/${p}`)} />} />
        <Route path="/resultado" element={viewingAudit ? (
          <AuditResult 
        ...
        <Route path="/guia" element={<UserGuide onNavigate={(p) => navigate(`/${p}`)} />} />
        <Route path="*" element={<Dashboard audits={filteredAudits} obras={allObras} onNavigate={(p) => navigate(`/${p}`)} user={user} />} />
      </Routes>
    </Layout>
  );
